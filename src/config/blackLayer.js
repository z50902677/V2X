{
  ...
  "layers" :[{
    ...
    "id": "c2704ceb8a3e471d97add4e764fbe525",
    "maxzoom": 6.0,
    ...
    "id": "6b469cb85a6e47188dd9054ddad79a4a",
    "maxzoom": 8.5,
    ...
    "id": "786f9dcd2d8c4e23a704d365fdfaaa28",
    "maxzoom": 17.5,
    ...
    "id": "222981cd05e947c68f813fc8c275a227",
    "maxzoom": 8.0,
    "source": "Waterline",
    ...
    "id": "1b009d6466e54508bbee259e45ccedd9",
    "maxzoom": 17.5,
    "source": "satellite",
    "layout": { "visibility": "none" },
    "source-layer": "satellite",
    "paint": { "raster-fade-duration": 0.001 },
    "minzoom": 3,
    "type": "raster"
  }, {
    "id": "b3ee9e24c2d94b05863b52e42b61a73c",
    "maxzoom": 13.5,
    "source": "Hillshade",
    "layout": { "visibility": "none" },
    ...
    "id": "29808b11ebba45fe8fa13e4293f717f9",
    "maxzoom": 17.5,
    ...
    "minzoom": 5.0,
    "type": "line",
    "filter": ["all", ["==", "kind", 4], ["!=", "const_st", 3], ["!arrin", "form", "15"]]
  }, {
    ...
    "minzoom": 5.0,
    "type": "line",
    "filter": ["all", ["==", "kind", 3], ["!=", "const_st", 3], ["!arrin", "form", "15"]]
  }, {
    ...
    "minzoom": 10.0,
    "type": "line",
    "filter": ["all", ["!=", "const_st", 3], ["==", "kind", 2], ["!arrin", "form", "10"]]
  }, {
    ...
    "minzoom": 10.0,
    "type": "line",
    "filter": ["all", ["!=", "const_st", 3], ["==", "kind", 1], ["!arrin", "form", "10"]]
  }, {
    ...
    "minzoom": 14.0,
    "type": "line",
    "filter": ["all", ["==", "kind", 4], ["!=", "const_st", 3], ["!arrin", "form", "37", "39", "10", "38", "15"]]
  }, {
    ...
    "minzoom": 14.0,
    "type": "line",
    "filter": ["all", ["==", "kind", 3], ["!=", "const_st", 3], ["arrin", "form", "37", "39", "10", "38", "15"]]
  }, {
    ...
    "minzoom": 14.0,
    "type": "line",
    "filter": ["all", ["!=", "const_st", 3], ["==", "kind", 2], ["arrin", "form", "12", "13", "39", "36", "11", "10", "15"]]
  }, {
    ...
    "minzoom": 14.0,
    "type": "line",
    "filter": ["all", ["!=", "const_st", 3], ["==", "kind", 1], ["arrin", "form", "12", "13", "39", "36", "11", "10", "15"]]
  }, {
    ...
    "id": "4be2e64dd0634130b70892e2de54029e",
    "maxzoom": 17.5,
    "source": "Zlevel",
    "layout": { "line-join": "round", "visibility": "visible", "line-cap": "butt" },
    "paint": {
      ...
      "line-translate-anchor": "viewport",
      "line-color": "#071733",
      "line-width": { "stops": [[13, 0], [14, 0.6], [15, 0.8], [16, 1], [17, 1.2], [18, 1.2], [19, 1.2]], "base": 1.2 }
    },
    "source-layer": "Zlevel",
    "minzoom": 15.0,
    "type": "line",
    ...
    "id": "bde4f54a5f54499e94fb32a229a9c73b",
    "maxzoom": 17.5,
    "source": "Zlevel",
    "layout": { "line-join": "round", "visibility": "visible", "line-cap": "butt" },
    "source-layer": "Zlevel",
    ...
    "id": "7b104dc57c1b4529a93e7b0171a11b36",
    "maxzoom": 17.5,
    "source": "Zlevel",
    "layout": { "line-join": "round", "visibility": "visible", "line-cap": "butt" },
    "paint": {
      "line-gap-width": {
        "stops": [[13, 2], [14, 2.8], [15, 7.2], [16, 10], [17, 20], [18, 20], [19, 20]],
        "base": 1.2
      },
      "line-translate-anchor": "viewport",
      "line-color": "#071733",
      "line-width": {
        "stops": [[13, 0.8], [14, 0.9], [15, 1], [16, 1.2], [17, 1.4], [18, 1.4], [19, 1.4]],
        "base": 1.2
      }
    },
    "source-layer": "Zlevel",
    ...
    "id": "5afb7f8eeeb840e68e3798f0323f42df",
    "maxzoom": 17.5,
    "source": "Zlevel",
    "layout": { "line-join": "round", "visibility": "visible", "line-cap": "butt" },
    "paint": {
      "line-translate-anchor": "viewport",
      "line-color": "#0f3865",
      "line-width": { "stops": [[13, 2], [14, 2.8], [15, 7.2], [16, 10], [17, 20], [18, 20], [19, 20]], "base": 1.2 }
    },
    "source-layer": "Zlevel",
    "minzoom": 15.0,
    "type": "line",
    ...
    "id": "a9ebba5efb9a49f69902a1952e1e286e",
    "maxzoom": 17.5,
    "source": "Zlevel",
    "layout": { "line-join": "round", "visibility": "visible", "line-cap": "butt" },
    "source-layer": "Zlevel",
    ...
    "minzoom": 15.0,
    "type": "line",
    "filter": ["all", ["==", "kind", 6], [">=", "zvalue", 1]]
  }, {
    "id": "2e6502c08aa64e2b904ecc2fffaea9b0",
    "maxzoom": 17.5,
    "source": "Zlevel",
    "layout": { "line-join": "round", "visibility": "visible", "line-cap": "butt" },
    "paint": {
    ...
    "id": "d725709becf742f9996c762a6cf0575c",
    "maxzoom": 17.5,
    "source": "Zlevel",
    "layout": { "line-join": "round", "visibility": "visible", "line-cap": "butt" },
    "paint": {
      "line-gap-width": {
        "stops": [[13, 2], [14, 2.4], [15, 2.8], [16, 5.5], [17, 11], [18, 11], [19, 11]],
        "base": 1.2
      },
      "line-translate-anchor": "viewport",
      "line-color": "#0d488a",
    ...
    "minzoom": 15.0,
    "type": "line",
    "filter": ["all", ["==", "kind", 4], [">=", "zvalue", 1], ["arrin", "form", "37", "39", "10", "38", "15"]]
  }, {
    "id": "26bfd04a591b4b7095acd0dc2ad738f1",
    "maxzoom": 17.5,
    "source": "Zlevel",
    "layout": { "line-join": "round", "visibility": "visible", "line-cap": "round" },
    "source-layer": "Zlevel",
    "paint": {
      "line-translate-anchor": "viewport",
      "line-color": "#1e5aa5",
      "line-width": { "stops": [[13, 2], [14, 2.4], [15, 2.8], [16, 5.5], [17, 11], [18, 11], [19, 11]], "base": 1.2 }
    },
    "minzoom": 15.0,
    "type": "line",
    "filter": ["all", ["==", "kind", 4], [">=", "zvalue", 1], ["arrin", "form", "37", "39", "10", "38", "15"]]
  }, {
    "id": "5f7a27e5aa8c4417820d3b70329155fa",
    "maxzoom": 17.5,
    "source": "Zlevel",
    "layout": { "line-join": "round", "visibility": "visible", "line-cap": "butt" },
    "paint": {
    ...
    "id": "1a7c0c57cea3491da1bd443e3e38a922",
    "maxzoom": 17.5,
    "source": "Zlevel",
    "layout": { "line-join": "round", "visibility": "visible", "line-cap": "round" },
    "paint": {
    ...
    "id": "d1bf26cc69bd458095e6a1e8ad2ba68a",
    "maxzoom": 17.5,
    "source": "Zlevel",
    "layout": { "line-join": "round", "visibility": "visible", "line-cap": "butt" },
    "source-layer": "Zlevel",
    ...
    "minzoom": 15.0,
    "type": "line",
    "filter": ["all", ["==", "kind", 3], ["arrin", "form", "37", "14", "36", "10", "38", "15"], [">=", "zvalue", 1]]
  }, {
    "id": "7786cb3985a14a20b8cc5404fa671621",
    "maxzoom": 17.5,
    "source": "Zlevel",
    "layout": { "line-join": "round", "visibility": "visible", "line-cap": "round" },
    "source-layer": "Zlevel",
    ...
    "id": "f740f736378d4c94ba0f53f740328e45",
    "maxzoom": 17.5,
    "source": "Zlevel",
    "layout": { "line-join": "round", "visibility": "visible", "line-cap": "butt" },
    "paint": {
    ...
    "minzoom": 15.0,
    "type": "line",
    "filter": ["all", ["==", "kind", 3], [">=", "zvalue", 1], ["arrin", "form", "37", "14", "36", "10", "38", "15"]]
  }, {
    "id": "b7765e09be424cbb832c36b53423df2b",
    "maxzoom": 17.5,
    "source": "Zlevel",
    "layout": { "line-join": "round", "visibility": "visible", "line-cap": "round" },
    "source-layer": "Zlevel",
    ...
    "id": "b5b89af61083446ab3a563a8899f03a2",
    "maxzoom": 17.5,
    "source": "Zlevel",
    "layout": { "line-join": "round", "visibility": "visible", "line-cap": "butt" },
    "source-layer": "Zlevel",
    "paint": {
      "line-translate-anchor": "viewport",
      "line-gap-width": { "stops": [[13, 2.4], [14, 3], [15, 6], [16, 9], [17, 18], [18, 18], [19, 18]], "base": 1.2 },
      "line-color": "#0d488a",
      "line-width": {
    ...
    "minzoom": 15.0,
    "type": "line",
    "filter": ["all", ["==", "kind", 2], ["arrin", "form", "12", "13", "39", "11", "10", "15"], [">=", "zvalue", 1]]
  }, {
    "id": "565fa8abfcf946478f6d0a8a007ae574",
    "maxzoom": 17.5,
    "source": "Zlevel",
    "layout": { "line-join": "round", "visibility": "visible", "line-cap": "round" },
    "paint": {
      "line-translate-anchor": "viewport",
      "line-color": "#1e5aa5",
      "line-width": { "stops": [[13, 2.4], [14, 3], [15, 6], [16, 9], [17, 18], [18, 18], [19, 18]], "base": 1.2 }
    },
    "source-layer": "Zlevel",
    "minzoom": 15.0,
    "type": "line",
    ...
    "id": "15eb172356e34adc8b5666d05d307be8",
    "maxzoom": 17.5,
    "source": "Zlevel",
    "layout": { "line-join": "round", "visibility": "visible", "line-cap": "butt" },
    "paint": {
    ...
    "id": "77c90cd1d34b459c8bef2fe8b01cdcc3",
    "maxzoom": 17.5,
    "source": "Zlevel",
    "layout": { "line-join": "round", "visibility": "visible", "line-cap": "round" },
    "paint": {
    ...
    "id": "4c1eded3316d43faa110a4f8683ab606",
    "maxzoom": 17.5,
    "source": "Zlevel",
    "layout": { "line-join": "round", "visibility": "visible", "line-cap": "butt" },
    "paint": {
      "line-translate-anchor": "viewport",
      "line-gap-width": {
        "stops": [[13, 2.4], [14, 3], [15, 5], [16, 7.5], [17, 15], [18, 15], [19, 15]],
        "base": 1.2
      },
      "line-color": "#0d488a",
      "line-width": {
        "stops": [[13, 1.2], [14, 1.2], [15, 1.4], [16, 1.6], [17, 1.6], [18, 1.6], [19, 1.6]],
        "base": 1.2
      }
    },
    "source-layer": "Zlevel",
    "minzoom": 15.0,
    "type": "line",
    "filter": ["all", ["==", "kind", 1], ["arrin", "form", "12", "13", "39", "11", "10", "15"], [">=", "zvalue", 1]]
  }, {
    "id": "98a68af6a0b24845bdf605ef6d235a5e",
    "maxzoom": 17.5,
    "source": "Zlevel",
    "layout": { "line-join": "round", "visibility": "visible", "line-cap": "round" },
    "source-layer": "Zlevel",
    "paint": {
      "line-translate-anchor": "viewport",
      "line-color": "#1e5aa5",
      "line-width": { "stops": [[13, 2.4], [14, 3], [15, 5], [16, 7.5], [17, 15], [18, 15], [19, 15]], "base": 1.2 }
    },
    "minzoom": 15.0,
    "type": "line",
    "filter": ["all", ["==", "kind", 1], ["arrin", "form", "12", "13", "39", "11", "10", "15"], [">=", "zvalue", 1]]
  }, {
    "id": "ee21b1a275794404987ce2a16c08561b",
    "maxzoom": 17.5,
    "source": "Zlevel",
    "layout": { "line-join": "round", "visibility": "visible", "line-cap": "butt" },
    "source-layer": "Zlevel",
    "paint": {
      "line-translate-anchor": "viewport",
      "line-gap-width": {
        "stops": [[13, 3], [14, 5], [15, 7.5], [16, 15], [17, 30], [18, 30], [19, 30], [20, 30]],
        "base": 1.2
      },
      "line-color": "#0d488a",
      "line-width": {
    ...
    "id": "eaa7914a3c824ca8b1bcb00a33ed6f51",
    "maxzoom": 17.5,
    "source": "Zlevel",
    "layout": { "line-join": "round", "visibility": "visible", "line-cap": "round" },
    "source-layer": "Zlevel",
    ...
    "minzoom": 13.0,
    "type": "line",
    "filter": ["all", ["==", "kind", 8], ["==", "const_st", 1], ["arrin", "form", "31"]]
  }, {
    ...
    "minzoom": 13.0,
    "type": "line",
    "filter": ["all", ["==", "kind", 7], ["!=", "const_st", 3], ["arrin", "form", "31"]]
  }, {
    ...
    "minzoom": 13.0,
    "type": "line",
    "filter": ["all", ["==", "kind", 6], ["!=", "const_st", 3], ["arrin", "form", "31"]]
  }, {
    ...
    "minzoom": 13.0,
    "type": "line",
    "filter": ["all", ["==", "kind", 4], ["==", "const_st", 1], ["arrin", "form", "31"]]
  }, {
    ...
    "minzoom": 13.0,
    "type": "line",
    "filter": ["all", ["==", "kind", 4], ["!=", "const_st", 3], ["arrin", "form", "31"]]
  }, {
    ...
    "minzoom": 13.0,
    "type": "line",
    "filter": ["all", ["==", "kind", 3], ["==", "const_st", 1], ["arrin", "form", "31"]]
  }, {
    ...
    "minzoom": 13.0,
    "type": "line",
    "filter": ["all", ["==", "kind", 3], ["!=", "const_st", 3], ["arrin", "form", "31"]]
  }, {
    ...
    "minzoom": 13.0,
    "type": "line",
    "filter": ["all", ["!=", "const_st", 3], ["==", "kind", 2], ["arrin", "form", "31"]]
  }, {
    ...
    "minzoom": 13.0,
    "type": "line",
    "filter": ["all", ["!=", "const_st", 3], ["==", "kind", 1], ["arrin", "form", "31"]]
  }, {
    ...
    "id": "04d1e93cc0344264852f5a37b9e65072",
    "maxzoom": 17.5,
    "source": "Ptline",
    "layout": { "line-join": "round", "visibility": "visible", "line-cap": "butt" },
    "paint": {
      ...
      "line-opacity": 1.0,
      "line-color": "#071733",
      "line-width": { "stops": [[10, 2.8], [19, 6]], "base": 1.2 }
    },
    "source-layer": "Ptline",
    "minzoom": 10,
    "type": "line",
    ...
    "id": "b6f379855e6c4c0c89b780cc22df61fa",
    "maxzoom": 17.5,
    "source": "Ptline",
    "layout": { "line-join": "round", "visibility": "visible", "line-cap": "butt" },
    "source-layer": "Ptline",
    ...
    "id": "882ff5c4ede04309b9bbeba17a1cfbdb",
    "maxzoom": 17.5,
    "source": "Traffic",
    "layout": { "line-join": "round", "visibility": "none", "line-cap": "round" },
    "source-layer": "Trafficrtic",
    "paint": {
      "line-gap-width": { "stops": [[5, 0.8], [9, 1.6], [12, 1.2], [19, 6]], "base": 1 },
      "line-color": "#ffffff",
      "line-width": { "stops": [[5, 1], [9, 1.2], [12, 1.8], [19, 2.4]], "base": 1.2 }
    },
    "minzoom": 13.0,
    "type": "line",
    "filter": ["all", ["==", "function_class", 5]]
  }, {
    "id": "971ee7b44ac346568ff5e00c88100ca6",
    "maxzoom": 17.5,
    "source": "Traffic",
    "layout": { "line-join": "round", "visibility": "none", "line-cap": "round" },
    "source-layer": "Trafficrtic",
    "paint": {
      "line-color": {
        "stops": [[0, "#b3b3b3"], [1, "#1fab6c"], [2, "#dea927"], [3, "#c03b37"], [4, "#7f060e"]],
        "property": "status"
      }, "line-width": { "stops": [[5, 0.8], [9, 1.6], [12, 1.2], [19, 6]], "base": 1.2 }
    },
    "minzoom": 13.0,
    "type": "line",
    "filter": ["all", ["==", "function_class", 5]]
  }, {
    "id": "718b7a0345fd4f0eb704e07378f04327",
    "maxzoom": 17.5,
    "source": "Traffic",
    "layout": { "line-join": "round", "visibility": "none", "line-cap": "round" },
    "source-layer": "Trafficrtic",
    "paint": {
      "line-gap-width": { "stops": [[5, 0.8], [9, 1.6], [12, 1.2], [19, 6]], "base": 1 },
      "line-color": "#ffffff",
      "line-width": { "stops": [[5, 1], [9, 1.2], [12, 1.6], [19, 2.4]], "base": 1.2 }
    },
    "minzoom": 12,
    "type": "line",
    "filter": ["all", ["==", "function_class", 4]]
  }, {
    "id": "473e0c9da84b4f61b85f0dcfacacf8b9",
    "maxzoom": 17.5,
    "source": "Traffic",
    "layout": { "line-join": "round", "visibility": "none", "line-cap": "round" },
    "source-layer": "Trafficrtic",
    "paint": {
      "line-color": {
        "stops": [[0, "#b3b3b3"], [1, "#1fab6c"], [2, "#dea927"], [3, "#c03b37"], [4, "#7f060e"]],
        "property": "status"
      }, "line-width": { "stops": [[5, 0.8], [9, 1.6], [12, 2], [19, 6]], "base": 1.2 }
    },
    "minzoom": 12.0,
    "type": "line",
    "filter": ["all", ["==", "function_class", 4]]
  }, {
    "id": "df1328ee1e3649ec967f93dd66d3dffc",
    "maxzoom": 17.5,
    "source": "Traffic",
    "layout": { "line-join": "round", "visibility": "none", "line-cap": "round" },
    "source-layer": "Trafficrtic",
    "paint": {
      "line-gap-width": { "stops": [[5, 1], [9, 2.4], [12, 2], [19, 7.2]], "base": 1 },
      "line-color": "#ffffff",
      "line-width": { "stops": [[5, 1], [9, 1.4], [12, 2], [19, 2.4]], "base": 1.2 }
    },
    "minzoom": 12,
    "type": "line",
    "filter": ["all", ["in", "function_class", 1, 2, 3]]
  }, {
    "id": "06de8295ea7244f4a64242a0c599918d",
    "maxzoom": 17.5,
    "source": "Traffic",
    "layout": { "line-join": "round", "visibility": "none", "line-cap": "round" },
    "source-layer": "Trafficrtic",
    "paint": {
      "line-color": {
        "stops": [[0, "#b3b3b3"], [1, "#1fab6c"], [2, "#dea927"], [3, "#c03b37"], [4, "#7f060e"]],
        "property": "status"
      }, "line-width": { "stops": [[5, 1], [9, 2.4], [12, 2], [19, 7.2]], "base": 1.2 }
    },
    "minzoom": 12.0,
    "type": "line",
    "filter": ["all", ["in", "function_class", 1, 2, 3]]
  }, {
    "id": "3b3bcb19beed49ecbdfefe1d6feaa2ac",
    "maxzoom": 12.0,
    "source": "Traffic",
    "layout": { "line-join": "round", "visibility": "none", "line-cap": "round" },
    "source-layer": "Trafficrtic",
    "paint": {
      "line-gap-width": { "stops": [[5, 1], [9, 2.4], [12, 2], [19, 7.2]], "base": 1 },
      "line-color": "#ffffff",
      "line-width": { "stops": [[5, 1], [9, 1.4], [12, 1.8], [19, 2.4]], "base": 1.2 }
    },
    "minzoom": 8.0,
    "type": "line",
    "filter": ["all", ["==", "function_class", 2]]
  }, {
    "id": "cfd7b21c0e7f4fc5ba5efd9ed7899582",
    "maxzoom": 12.0,
    "source": "Traffic",
    "layout": { "line-join": "round", "visibility": "none", "line-cap": "round" },
    "source-layer": "Trafficrtic",
    ...
    "id": "9e96cf1a36774d49b45c2cfa28952f83",
    "maxzoom": 12.0,
    "source": "Traffic",
    "layout": { "line-join": "round", "visibility": "none", "line-cap": "round" },
    "source-layer": "Trafficrtic",
    ...
    "id": "5a1f64d581de426aac00c21c815d8763",
    "maxzoom": 12.0,
    "source": "Traffic",
    "layout": { "line-join": "round", "visibility": "none", "line-cap": "round" },
    "source-layer": "Trafficrtic",
    ...
    "id": "45b0c03b6a0d44c5a24166f748657d3d",
    "maxzoom": 8.0,
    "source": "Traffic",
    "layout": { "line-join": "round", "visibility": "none", "line-cap": "round" },
    "source-layer": "Trafficrtic",
    ...
    "id": "616bf07f4e6e4aafb6822b1bad86a3d7",
    "maxzoom": 8.0,
    "source": "Traffic",
    "layout": { "line-join": "round", "visibility": "none", "line-cap": "round" },
    "source-layer": "Trafficrtic",
    ...
    "id": "23f7222d28124e47bf26902d2cc1a673",
    "maxzoom": 17.5,
    "source": "Ptstop",
    "layout": {
    ...
    "source-layer": "Ptstop",
    "paint": { "icon-translate-anchor": "viewport", "icon-color": "#e67a7f" },
    "minzoom": 15.0,
    "type": "symbol",
    ...
    "minzoom": 13.0,
    "type": "symbol",
    "filter": ["all", ["==", "kindcode", "200101"], ["!arrin", "rank", 2, 3]]
  }, {
    ...
    "id": "44936038ad154c0fbe1a64cc917ea827",
    "maxzoom": 17.5,
    "source": "Ptline",
    "layout": {
      "text-size": {
        "stops": [[10, 11], [11, 11], [12, 11], [13, 11], [14, 12], [15, 12], [16, 12], [17, 13], [18, 13], [19, 13]],
        "base": 1
      },
      "text-pitch-alignment": "viewport",
      "visibility": "visible",
    ...
    "id": "ff2c4331cc9a4b4b90fe02fe21bc819d",
    "maxzoom": 17.5,
    "source": "Trafficlight",
    "layout": { "icon-image": "traffic-light-15", "visibility": "visible", "icon-rotation-alignment": "viewport" },
    "source-layer": "Trafficlight",
    "paint": { "icon-translate-anchor": "viewport", "icon-color": "#ff0000" },
    "minzoom": 16.0,
    "type": "symbol"
  }, {
    "id": "7c543555b2e944b98231fceb2485495a",
    "maxzoom": 13.0,
    "source": "Ptstop",
    "layout": {
      "text-size": 12,
    ...
    "id": "e98f15ee258841a59ad715d30a8c4f11",
    "maxzoom": 15.0,
    "source": "Ptstop",
    "layout": {
      "text-size": 12.0,
    ...
    "minzoom": 13.0,
    "type": "symbol",
    "filter": ["all", ["==", "stationtype", 1], ["==", "status", 0]]
  }, {
    "id": "f0b6305d11e342379e95dc32c3780568",
    "maxzoom": 16.0,
    "source": "Ptstop",
    "layout": {
      "text-size": 13.0,
    ...
    "id": "42f61c69e9464e8b926018bd1eb18bd3",
    "maxzoom": 17.5,
    "source": "Ptstop",
    "layout": {
      "text-size": 14.0,
    ...
    "source-layer": "Ptstop",
    "paint": { "text-halo-color": "#0e2555", "text-halo-width": 1, "text-color": "#59c3ed", "icon-color": "#ff0000" },
    "minzoom": 16.0,
    "type": "symbol",
    "filter": ["all", ["==", "stationtype", 1], ["==", "status", 0]]
  }, {
    ...
    "id": "61b1455479c940a888a9a018e974ea12",
    "maxzoom": 17.5,
    "source": "Ptexit",
    "layout": {
      "text-size": 12.0,
    ...
    "id": "3315839aeabc4eddaad97724828ebd3f",
    "maxzoom": 8.0,
    ...
    "id": "7ab9478ef04a4caba4ba0d3452155a12",
    "maxzoom": 8.0,
    "source": "Worldannotation",
    "layout": {
      "text-size": 14.0,
    ...
    "minzoom": 4.0,
    "type": "symbol",
    "filter": ["all", ["==", "kind", "275008"], ["!in", "name_zh", "台湾海峡"]]
  }, {
    ...
    "id": "8e61ac91a6de4ff48bcaab252c20d9ee",
    "maxzoom": 4.0,
    "source": "Worldannotation",
    "layout": {
      "text-size": 20.0,
    ...
    "minzoom": 3,
    "type": "symbol",
    "filter": ["all", ["==", "name_zh", "中华人民共和国"], ["==", "kind", "405001"]]
  }, {
    "id": "80fdee576a824618b1329bf7c6214c12",
    "maxzoom": 8.5,
    "source": "Worldannotation",
    "layout": {
      "text-size": 24.0,
    ...
    "id": "04cf8343d80d47b8a38461f1e6f1d2e3",
    "maxzoom": 17.5,
    "source": "Event",
    "layout": { "icon-image": "event-app-{teyetype}-18", "visibility": "none" },
    "paint": {},
    "source-layer": "Event",
    "minzoom": 10,
    "type": "symbol"
...
:
  ...
  :
    {
      "tiles"
    :
      ["//p1.map.gtimg.com/sateTiles/{z}/{m}/{n}/{x}_{y}.jpg?version=228"], "scheme"
    :
      "tms", "tileSize"
    :
      256, "type"
  ...
  :
    {
      "tiles"
    :
      ["minemapdata://Worldannotation/{z}/{x}/{y}"], "type"
    :
      "vector"
    }
  ,
  ...
  :
    {
      "tiles"
    :
      ["minemapdata://Trafficlight/{z}/{x}/{y}"], "type"
    :
      "vector"
    }
  ,
  ...
  :
    {
      "tiles"
    :
      ["minemapdata://Landuse/{z}/{x}/{y}"], "type"
    :
      "vector"
    }
  ,
  ...
  :
    {
      "tiles"
    :
      ["minemapdata://Villtown/{z}/{x}/{y}"], "type"
    :
      "vector"
    }
  ,
  ...
  :
    {
      "tiles"
    :
      ["minemapdata://Greenface/{z}/{x}/{y}"], "type"
    :
      "vector"
    }
  ,
  ...
  :
    {
      "tiles"
    :
      ["minemapdata://Waterline/{z}/{x}/{y}"], "type"
    :
      "vector"
    }
  ,
  ...
  :
    {
      "tiles"
    :
      ["minemapdata://Subwaypolygon/{z}/{x}/{y}"], "type"
    :
      "vector"
    }
  ,
  ...
  :
    {
      "tiles"
    :
      ["minemapdata://Worldwaterface/{z}/{x}/{y}"], "type"
    :
      "vector"
    }
  ,
  ...
  :
    {
      "tiles"
    :
      ["minemapdatad://Trafficrtic/{z}/{x}/{y}"], "traffic"
    :
      true, "type"
    :
      "vector"
  ...
  :
    {
      "tiles"
    :
      ["minemapdata://Waterface/{z}/{x}/{y}"], "type"
    :
      "vector"
    }
  ,
  ...
  :
    {
      "tiles"
    :
      ["minemapdatao://hillshade/{z}/{x}/{y}"], "type"
    :
      "raster"
    }
  ,
  ...
  :
    {
      "tiles"
    :
      ["minemapdata://Adminbound/{z}/{x}/{y}"], "type"
    :
      "vector"
    }
  ,
  ...
  :
    {
      "tiles"
    :
      ["minemapdata://Railway/{z}/{x}/{y}"], "type"
    :
      "vector"
    }
  ,
  ...
  :
    {
      "tiles"
    :
      ["minemapdata://Adminflag/{z}/{x}/{y}"], "type"
    :
      "vector"
    }
  ,
  ...
  :
    {
      "tiles"
    :
      ["minemapdata://Annotation/{z}/{x}/{y}"], "type"
    :
      "vector"
    }
  ,
  ...
  :
    {
      "tiles"
    :
      ["minemapdata://Buildingmore/{z}/{x}/{y}"], "type"
    :
      "vector"
    }
  ,
  ...
  :
    ...
    :
      17, "tiles"
    :
      ["minemapdata://ResidentialPolygon/{z}/{x}/{y}"], "type"
    :
      "vector"
    }
  ,
  ...
  :
    {
      "tiles"
    :
      ["minemapdata://Worldcountries/{z}/{x}/{y}"], "type"
    :
      "vector"
    }
  }
