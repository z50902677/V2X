const simple = {
  ...
  "sources":
    {
      "Worldannotation": {
        "tiles": ["http://fs.navinfo.com/smapapi/smap-data/data/Worldannotation/{z}/{x}/{y}?token=25cc55a69ea7422182d00d6b7c0ffa93&solu=716"],
        "type": "vector"
      },
      "Building": {
        "tiles": ["http://fs.navinfo.com/smapapi/smap-data/data/Building/{z}/{x}/{y}?token=25cc55a69ea7422182d00d6b7c0ffa93&solu=716"],
        "type": "vector"
      },
      "Landuse": {
        "tiles": ["http://fs.navinfo.com/smapapi/smap-data/data/Landuse/{z}/{x}/{y}?token=25cc55a69ea7422182d00d6b7c0ffa93&solu=716"],
        "type": "vector"
      },
      "Worldislands": {
        "tiles": ["http://fs.navinfo.com/smapapi/smap-data/data/Worldislands/{z}/{x}/{y}?token=25cc55a69ea7422182d00d6b7c0ffa93&solu=716"],
        "type": "vector"
      },
      "Ptline": {
        "tiles": ["http://fs.navinfo.com/smapapi/smap-data/data/Ptline/{z}/{x}/{y}?token=25cc55a69ea7422182d00d6b7c0ffa93&solu=716"],
        "type": "vector"
      },
      "Villtown": {
        "tiles": ["http://fs.navinfo.com/smapapi/smap-data/data/Villtown/{z}/{x}/{y}?token=25cc55a69ea7422182d00d6b7c0ffa93&solu=716"],
        "type": "vector"
      },
      "Greenface": {
        "tiles": ["http://fs.navinfo.com/smapapi/smap-data/data/Greenface/{z}/{x}/{y}?token=25cc55a69ea7422182d00d6b7c0ffa93&solu=716"],
        "type": "vector"
      },
      "Worldwaterface": {
        "tiles": ["http://fs.navinfo.com/smapapi/smap-data/data/Worldwaterface/{z}/{x}/{y}?token=25cc55a69ea7422182d00d6b7c0ffa93&solu=716"],
        "type": "vector"
      },
      "Waterline": {
        "tiles": ["http://fs.navinfo.com/smapapi/smap-data/data/Waterline/{z}/{x}/{y}?token=25cc55a69ea7422182d00d6b7c0ffa93&solu=716"],
        "type": "vector"
      },
      "Subwaypolygon": {
        "tiles": ["http://fs.navinfo.com/smapapi/smap-data/data/Subwaypolygon/{z}/{x}/{y}?token=25cc55a69ea7422182d00d6b7c0ffa93&solu=716"],
        "type": "vector"
      },
      "Ptexit": {
        "tiles": ["http://fs.navinfo.com/smapapi/smap-data/data/Ptexit/{z}/{x}/{y}?token=25cc55a69ea7422182d00d6b7c0ffa93&solu=716"],
        "type": "vector"
      },
      "Poi": {
        "tiles": ["http://fs.navinfo.com/smapapi/smap-data/data/Poi/{z}/{x}/{y}?token=25cc55a69ea7422182d00d6b7c0ffa93&solu=716"],
        "type": "vector"
      },
      "Waterface": {
        "tiles": ["http://fs.navinfo.com/smapapi/smap-data/data/Waterface/{z}/{x}/{y}?token=25cc55a69ea7422182d00d6b7c0ffa93&solu=716"],
        "type": "vector"
      },
      "Adminbound": {
        "tiles": ["http://fs.navinfo.com/smapapi/smap-data/data/Adminbound/{z}/{x}/{y}?token=25cc55a69ea7422182d00d6b7c0ffa93&solu=716"],
        "type": "vector"
      },
      "Ptstop": {
        "tiles": ["http://fs.navinfo.com/smapapi/smap-data/data/Ptstop/{z}/{x}/{y}?token=25cc55a69ea7422182d00d6b7c0ffa93&solu=716"],
        "type": "vector"
      },
      "Railway": {
        "tiles": ["http://fs.navinfo.com/smapapi/smap-data/data/Railway/{z}/{x}/{y}?token=25cc55a69ea7422182d00d6b7c0ffa93&solu=716"],
        "type": "vector"
      },
      "Adminflag": {
        "tiles": ["http://fs.navinfo.com/smapapi/smap-data/data/Adminflag/{z}/{x}/{y}?token=25cc55a69ea7422182d00d6b7c0ffa93&solu=716"],
        "type": "vector"
      },
      "Annotation": {
        "tiles": ["http://fs.navinfo.com/smapapi/smap-data/data/Annotation/{z}/{x}/{y}?token=25cc55a69ea7422182d00d6b7c0ffa93&solu=716"],
        "type": "vector"
      },
      "Worldwaterline": {
        "tiles": ["http://fs.navinfo.com/smapapi/smap-data/data/Worldwaterline/{z}/{x}/{y}?token=25cc55a69ea7422182d00d6b7c0ffa93&solu=716"],
        "type": "vector"
      },
      "Buildingmore": {
        "tiles": ["http://fs.navinfo.com/smapapi/smap-data/data/Buildingmore/{z}/{x}/{y}?token=25cc55a69ea7422182d00d6b7c0ffa93&solu=716"],
        "type": "vector"
      },
      "Road": {
        "tiles": ["http://fs.navinfo.com/smapapi/smap-data/data/Road/{z}/{x}/{y}?token=25cc55a69ea7422182d00d6b7c0ffa93&solu=716"],
        "type": "vector"
      },
      "Worldcountries": {
        "tiles": ["http://fs.navinfo.com/smapapi/smap-data/data/Worldcountries/{z}/{x}/{y}?token=25cc55a69ea7422182d00d6b7c0ffa93&solu=716"],
        "type": "vector"
      }
    },
  ...
  "layers": [{
    ...
    "source-layer": "",
    "paint": { "background-color": "#f9f5ec" },
    "minzoom": 3.0,
    "type": "background"
  }, {
    "id": "c3c621975f1341838ec859a443a3448d",
    "maxzoom": 5,
    "source": "Worldwaterface",
    "layout": { "visibility": "visible" },
    "source-layer": "Worldwaterface",
    "paint": { "fill-color": "#aee1f5" },
    "minzoom": 3,
    "type": "fill"
  }, {
    "id": "e133d93037f44ea9b5fca522c7267522",
    "maxzoom": 8.5,
    "source": "Worldcountries",
    "layout": { "visibility": "visible" },
    "source-layer": "Worldcountries",
    "paint": { "fill-color": "#f9f5ec" },
    "minzoom": 3,
    "type": "fill"
  }, {
    ...
    "source": "Landuse",
    "layout": { "visibility": "visible" },
    "paint": { "fill-outline-color": "#c0edb6", "fill-color": "#c0edb6", "fill-antialias": true },
    ...
    "source": "Landuse",
    "layout": { "visibility": "visible" },
    "paint": { "fill-outline-color": "#d1e4ee", "fill-color": "#d1e4ee", "fill-antialias": true },
    "source-layer": "Landuse",
    "minzoom": 12,
    "type": "fill",
    "filter": ["all", ["==", "kind", 11]]
    ...
    "source": "Landuse",
    "layout": { "visibility": "visible" },
    "paint": { "fill-outline-color": "#c6ccce", "fill-color": "#c6ccce", "fill-antialias": true },
    "source-layer": "Landuse",
    "minzoom": 12,
    "type": "fill",
    "filter": ["all", ["==", "kind", 12]]
    ...
    "layout": { "visibility": "visible" },
    "source-layer": "Landuse",
    "paint": { "fill-outline-color": "#e9e6df", "fill-color": "#e9e6df", "fill-antialias": true },
    "minzoom": 12,
    "type": "fill",
    "filter": ["all", ["==", "kind", 7]]
  }, {
    ...
    "source": "Landuse",
    "layout": { "visibility": "visible" },
    "paint": { "fill-outline-color": "#e9e0ed", "fill-color": "#e9e0ed", "fill-antialias": true },
    "source-layer": "Landuse",
    "minzoom": 12,
    "type": "fill",
    ...
    "source": "Landuse",
    "layout": { "visibility": "visible" },
    "paint": { "fill-outline-color": "#e7e4e4", "fill-color": "#e7e4e4", "fill-antialias": true },
    "source-layer": "Landuse",
    "minzoom": 12,
    "type": "fill",
    ...
    "layout": { "visibility": "visible" },
    "source-layer": "Landuse",
    "paint": { "fill-outline-color": "#fdd5e8", "fill-color": "#fdd5e8", "fill-antialias": true },
    "minzoom": 12,
    "type": "fill",
    "filter": ["all", ["==", "kind", 3]]
  }, {
    ...
    "layout": { "visibility": "visible" },
    "source-layer": "Landuse",
    "paint": { "fill-outline-color": "#dcedf2", "fill-color": "#dcedf2", "fill-antialias": true },
    "minzoom": 12,
    "type": "fill",
    "filter": ["all", ["==", "kind", 1]]
  }, {
    ...
    "id": "096a6c24cafd459cbbf2ca636e3d6e3a",
    "maxzoom": 7.0,
    "source": "Waterline",
    ...
    "source": "Adminbound",
    "layout": { "line-join": "round", "visibility": "visible", "line-cap": "round" },
    "paint": { "line-dasharray": [5, 3], "line-color": "#999999", "line-opacity": 1.0, "line-width": 1.0 },
    "source-layer": "Adminbound",
    "minzoom": 3,
    "type": "line",
    "filter": ["all", ["==", "kind", 5]]
    ...
    "layout": { "line-join": "round", "visibility": "visible", "line-cap": "round" },
    "source-layer": "Adminbound",
    "paint": { "line-color": "#e69b25", "line-width": { "stops": [[3, 1], [8, 2]], "base": 1.2 } },
    "minzoom": 3,
    "type": "line",
    ...
    },
    {
      ...
      "source": "Railway",
      "layout": { "line-join": "round", "visibility": "visible", "line-cap": "round" },
      "paint": { "line-color": "#b5b2b0", "line-width": { "stops": [[6, 1.5], [20, 10]], "base": 1.2 } },
      ...
      "id": "2b25689458694bbe819cef78b7595eac",
      "maxzoom": 17.5,
    ...
    },
    {
      ...
      "id": "7912b8654ac4494c9b7f26db26fba0e2",
      "maxzoom": 12.0,
      "source": "Ptstop",
      "layout": { "text-size": 12.0, "icon-image": "metro-station", "visibility": "visible", "text-anchor": "center" },
      ...
      "id": "444b480a7e13405eb16e0d10508f2431",
      "maxzoom": 13.0,
      "source": "Ptstop",
      "layout": {
        "text-size": 12,
      ...
      "id": "be451f7420d54257a9b3aefa6117ab54",
      "maxzoom": 14.0,
      "source": "Ptstop",
      "layout": {
        "text-size": 12,
      ...
      "id": "6de26d572a0441e69e48746add701320",
      "maxzoom": 17.5,
      "source": "Ptstop",
      "layout": {
        "text-size": 12,
    ...
    },
    {
      ...
      "id": "85eaf225e0fe4b44a5a0f5f9dfe8a4e0",
      "maxzoom": 17.5,
      "source": "Ptstop",
      "layout": { "icon-image": "poi_code_230100_16", "symbol-avoid-edges": true, "visibility": "visible" },
      ...
      "id": "ac1d7bd316f148449b849e44d9cb2cac",
      "maxzoom": 4.0,
      ...
      "id": "74595923d59645a084fb296222d46159",
      "maxzoom": 8.5,
      "source": "Worldannotation",
      "layout": {
        "text-size": 14.0,
      ...
      "id": "2a1331dadae0472e82b3a30f21494f1f",
      "maxzoom": 8.5,
      "source": "Worldannotation",
      "layout": {
        "text-size": 14.0,
      ...
      "id": "885812da7fd54bbf8e7bbba167ddf115",
      "maxzoom": 8.5,
      "source": "Worldannotation",
      "layout": {
        "text-size": 24.0,
      ...
      "id": "a6a58e141c204418bd95dc29598a6d7e",
      "maxzoom": 8.5,
      "source": "Worldannotation",
      "layout": {
        "text-size": 20.0,
      ...
      "id": "75b9e4c7c54c4798a18064d38fc132a0",
      "maxzoom": 17.5,
      "source": "Ptexit",
      "layout": {
        "text-size": 12.0,
